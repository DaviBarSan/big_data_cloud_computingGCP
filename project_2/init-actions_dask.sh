...
readonly DASK_VERSION='2022.1.1'
...
function main() {
  ...
  execute_with_retries "conda install -y dask=${DASK_VERSION} -c conda-forge"
  # Install conda packages
  execute_with_retries "mamba install -y ${CONDA_PACKAGES[*]} -c conda-forge"
